...
export class SetSbrStakingPoolRewardsAction extends Action {
    private contracts: any;
    constructor(contracts: any) {
        super("SetSbrStakingPoolRewards");
    }

    async initialize(context: RunContext, actor: Actor, currentSnapshot: Snapshot): Promise<[any, Record<string, any>]> {
        actor.log("Generating execution parameters for SetSbrStakingPoolRewards action..");
