...
export class LiquidateSafesAction extends Action {
    private contracts: any;
    constructor(contracts: any) {
        super("LiquidateSafes");
    }

    async initialize(context: RunContext, actor: Actor, currentSnapshot: Snapshot): Promise<[any, Record<string, any>]> {
        actor.log("Generating execution parameters for LiquidateSafes action..");
