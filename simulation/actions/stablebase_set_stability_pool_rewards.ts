...
export class SetStabilityPoolRewardsAction extends Action {
    private contracts: any;
    constructor(contracts: any) {
        super("SetStabilityPoolRewards");
    }

    async initialize(context: RunContext, actor: Actor, currentSnapshot: Snapshot): Promise<[any, Record<string, any>]> {
        actor.log("Generating execution parameters for SetStabilityPoolRewards action..");
