...
export class MintDfidAction extends Action {
    ...
    async initialize(context: RunContext, actor: Actor, currentSnapshot: Snapshot): Promise<[any, Record<string, any>]> {
        actor.log("Generating execution parameters for MintDfid action..");
