...
export class SetStabilityPoolAddressAction extends Action {
    private contracts: any;
    constructor(contracts: any) {
        super("SetStabilityPoolAddress");
    }

    async initialize(context: RunContext, actor: Actor, currentSnapshot: Snapshot): Promise<[any, Record<string, any>]> {
        actor.log("Generating execution parameters for SetStabilityPoolAddress action..");
