...
export class SetContractAddressesAction extends Action {
    private contracts: any;
    constructor(contracts: any) {
        super("SetContractAddresses");
    }

    async initialize(context: RunContext, actor: Actor, currentSnapshot: Snapshot): Promise<[any, Record<string, any>]> {
        actor.log("Generating execution parameters for SetContractAddresses action..");
